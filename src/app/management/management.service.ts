...
export class ManagementService {
  ...
  public activeUser (formData:Object): Observable<any>{
    this._logger.log("updateUser called.");

    let url = "https://erbium.ch/backend/api/user/active/"+formData['id'];
    let user_token = this._localstorage.getObject('user_token');
    let token = user_token.access_token;
  ...
  public deleteUser (formData:Object): Observable<any>{
      this._logger.log("updateUser called.");

    let url = "https://erbium.ch/backend/api/user/"+formData['id'];
    let user_token = this._localstorage.getObject('user_token');
    let token = user_token.access_token;
